...
typedef struct
{
     ...
     * TODO: signal data buffer should be 2D for group signals */
...
typedef struct
{
    ...
    const ComIPduSignalGroup_type* ComIPduSignalGroupRef;
